# CODE EXTRACTED AND ADAPTED FROM https://github.com/daavoo/pyntcloud/blob/master/pyntcloud/io/ply.py
# HAKUNA MATATA
...
def write_ply(filename, points=None, mesh=None, as_text=False, comments=None, points_as_float32 = True):
    ...
    if as_text:
        ...
        with open(filename, 'ab') as ply:            
            if points is not None:     
                if points_as_float32:           
                    points = points.astype(np.single) # use np.single for float32
